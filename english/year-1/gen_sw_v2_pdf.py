...
def create_sentences_v2_pdf(markdown_file, output_pdf, title, quiz_url):
    pdf = fpdf.FPDF()
    ...
    try:
        urllib.request.urlretrieve(api_url, "temp_qr_sw2.png")
        pdf.image("temp_qr_sw2.png", x=160, y=15, w=qr_size, h=qr_size)
        os.remove("temp_qr_sw2.png")
    except:
...
create_sentences_v2_pdf("teaching-materials/english/year-1/simple_present_15_sentences_v2.md", "teaching-materials/english/year-1/Simple_Present_Sentences_Set2.pdf", "Simple Present: 15 More Sentences", url)
